        ...
        with tf.device("/gpu:0"):
            with tf.Session(config=tf.ConfigProto(allow_soft_placement=True, log_device_placement=False)) as sess:
                ...
                for epoch in range(self.num_epochs):
                    ...
                    #     # a = self.manager.lookup_by('img_int', y[i])['name']
                    #     # b = self.manager.lookup_by('img_int', self.Y_test[i])['name']
                    #     a = y[i]
                    #     b = y_actual[i]
...
class NextItemsTrainer(Trainer):
    ...
    def build_next_items_early_game_model(self):
        ...
        f1_scores = np.array([0.00,0.53,0.62,0.41,0.40,0.72,0.69,0.59,0.50,0.50,0.71,0.35,0.72,0.63,0.63,0.78,0.82,0.70,
                          0.88,0.66,0.63,0.45,0.73,0.52,0.67,0.59,0.32,0.37,0.99,0.96,1.00,0.95,1.00,0.95,1.00,1.00,
                              0.81,0.60,0.67,0.97,0.80,0.17,0.48,0.56,0.64,0.47,0.90,0.88,0.95,0.87,0.30,0.91,0.63,1.00,0.92,0.95,0.97,0.93,0.97,0.95,0.97,0.33,0.00,1.00,0.39,0.92,0.52,0.85,0.92,0.88,1.00,0.90,0.97,0.72,0.97,0.96,0.96,0.92,0.98,0.00,0.71,0.95,0.98,0.76,0.89,1.00,0.96,0.87,1.00,1.00,0.94,0.89,1.00,0.86,1.00,0.92,0.77,0.73,0.95,0.67,0.89,0.56,0.95,1.00,0.72,0.69,0.06,0.99,0.82,0.80,0.36,0.38,0.00,0.54,0.75,1.00,0.92,0.92,0.95,0.75,1.00,0.97,0.97,0.71,0.92,0.97,0.19,0.93,0.94,0.95,1.00,0.90,0.67,0.00,0.00,0.00,0.81,1.00,0.96,0.00,0.25,0.50,0.00,0.80,1.00,0.00,0.00,0.29,0.44,0.48,0.50,0.00,0.00,0.95,1.00,0.78,0.72,0.76,0.95,0.78,0.88,0.98,1.00,0.93,1.00,0.86,1.00,0.79,0.66,0.92,0.83,0.90,0.55,0.82])
        f1_scores[f1_scores == 0] = 0.01
        f1_scores[f1_scores == 1] = 0.99
        self.class_weights *= 1-f1_scores
