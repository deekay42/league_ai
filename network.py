...
def classify_next_item(game_config, network_config):
    ...
    final_input_layer = merge([target_summ_champ, target_summ_items, target_summ_oppo, target_oppo_items, summed_items_by_champ, team1_score, team2_score, champs], mode='concat', axis=1)
